...
| `SolidWorks/Rendering` — GL interop, state guard, scene renderer, view hooks, job preview (stock box, origin triad, toolpaths), cut-direction arrows and the view scale that sizes them | Done | [Jobs](design/jobs.md) |
