...
- [Knowing when the model changed](rebuild-notifications.md) — which of the three regeneration notifications to take, why rollback counts as a rebuild, and doing as little as possible inside one.
